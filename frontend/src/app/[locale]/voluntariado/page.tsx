...
const areaConfig = [
  {
    ...
    image: "/images/programs/refuerzo-escolar.webp",
  },
  {
    key: "health",
    ...
    image: "/images/programs/psicologia.webp",
  },
  {
    key: "community",
    icon: FaUsers,
    ...
    image: "/images/programs/centro-comunitario.webp",
  },
  {
    key: "nutrition",
    icon: FaUtensils,
    ...
    image: "/images/programs/primera-infancia.webp",
  },
  {
    key: "inclusion",
    icon: FaHandsHelping,
    ...
    image: "/images/programs/tecnologia.webp",
  },
  {
    key: "management",
    icon: FaBriefcase,
    ...
    image: "/images/programs/escuela-padres.webp",
  },
];
...
const testimonialConfig = [{ key: "andrea" }, { key: "carlos" }, { key: "laura" }];
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-primary-900">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-28 text-center lg:px-8 lg:py-36">
          ...
          >
            {t("heroTitle")} <span className="bg-gradient-to-r from-green-400 to-green-300 bg-clip-text text-transparent">{t("heroHighlight")}</span>
          </motion.h1>
          ...
          >
            {[
              ...
              <div key={badge.label} className="flex items-center gap-2 text-sm text-primary-300/70">
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <ScrollReveal>
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-500">{t("reasonsSubtitle")}</p>
            </div>
          </ScrollReveal>
            ...
            {benefitConfig.map((benefit) => {
              ...
              return (
                <StaggerItem scaleUp key={benefit.key}>
                  ...
                  >
                    <div className={`mb-6 flex h-16 w-16 items-center justify-center rounded-2xl ${benefit.iconBg}`}>
                      <Icon className="h-8 w-8" />
                    </div>
                    <h3 className="mb-3 font-heading text-xl font-bold text-gray-900">{t(`benefits.${benefit.key}.title`)}</h3>
                    <p className="flex-1 leading-relaxed text-gray-600">{t(`benefits.${benefit.key}.description`)}</p>
                  </motion.div>
                </StaggerItem>
              );
            })}
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <ScrollReveal>
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-500">{t("areasSubtitle")}</p>
            </div>
          </ScrollReveal>
        ...
        <div className="mx-auto max-w-4xl px-4 lg:px-8">
          <ScrollReveal>
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto mt-4 max-w-xl text-gray-500">{t("requirementsSubtitle")}</p>
            </div>
          </ScrollReveal>
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <ScrollReveal>
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-500">{t("testimonialsSubtitle")}</p>
            </div>
          </ScrollReveal>
          ...
          <StaggerContainer scaleUp className="grid gap-8 md:grid-cols-3" staggerDelay={0.15}>
            {testimonialConfig.map((testimonial) => (
              <StaggerItem scaleUp key={testimonial.key}>
                ...
                >
                  {/* Quote icon */}
                  <div className="mb-5 text-4xl font-serif leading-none text-green-300">&ldquo;</div>

                  {/* Quote text */}
                  <p className="flex-1 leading-relaxed text-gray-600 italic">{t(`testimonials.${testimonial.key}.quote`)}</p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-heading font-bold text-gray-900">{t(`testimonials.${testimonial.key}.name`)}</p>
        ...
        <div className="mx-auto max-w-5xl px-4 lg:px-8">
          <ScrollReveal>
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-500">{t("processSubtitle")}</p>
            </div>
          </ScrollReveal>
              ...
              return (
                <StaggerItem scaleUp key={step.step}>
                  <div className="relative flex flex-col items-center text-center">
                    ...
                    <h3 className="mb-3 font-heading text-xl font-bold text-gray-900">{t(`applicationSteps.${step.key}.title`)}</h3>
                    <p className="leading-relaxed text-gray-600">{t(`applicationSteps.${step.key}.description`)}</p>
                  </div>
                </StaggerItem>
              );
            })}
      ...
      <section className="relative overflow-hidden bg-green-600 py-24">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center lg:px-8">
          <ScrollReveal>
            ...
            <h2 className="font-heading text-3xl font-bold text-white md:text-5xl">{t("ctaTitle")}</h2>
            <p className="mx-auto mt-4 max-w-2xl text-lg text-white/80">{t("ctaDescription")}</p>
