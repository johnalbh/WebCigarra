...
const departments = [
  {
    ...
    members: [
      { name: 'Carolyn Acosta', role: 'Fundadora y Directora', photo: '/images/team/carolyn-acosta.png' },
      { name: 'Esperanza Duque Castro', role: 'Administradora', photo: '/images/team/esperanza-duque.jpg' },
      { name: 'Karol Vanessa Gonzalez Rocha', role: 'Auxiliar Administrativa', photo: '/images/team/karol-gonzalez.jpg' },
      { name: 'Cristina Rocio Parra Lamprea', role: 'Trabajadora Social', photo: '/images/team/cristina-parra.png' },
      { name: 'Rubiela Pinzon', role: 'Contadora', photo: '/images/team/silueta.png' },
      { name: 'Zulma Rodriguez', role: 'Revisora Fiscal', photo: '/images/team/silueta.png' },
      { name: 'Erika Tatiana Santamaria Hernandez', role: 'Asistente de Informacion', photo: '/images/team/tatiana-santamaria.jpg' },
      { name: 'Maritzabel Escobar Meneses', role: 'Nutricionista', photo: '/images/team/maritzabel-escobar.jpg' },
    ],
  },
  {
    name: 'Equipo Docente',
    members: [
      { name: 'Narda Gissela Rocha Candela', role: 'Coordinadora General', photo: '/images/team/narda-rocha.jpg' },
      { name: 'Yeimi Rocio Forero Medina', role: 'Coordinadora Pedagogica', photo: '/images/team/yeimi-forero.jpg' },
      { name: 'Elvin Yezid Barbos Silva', role: 'Docente de Musica', photo: '/images/team/elvin-barbos.jpg' },
      { name: 'Sandra Lenith Beltran Suarez', role: 'Docente', photo: '/images/team/sandra-beltran.jpg' },
      { name: 'Andrea Liliana Capera Prada', role: 'Docente', photo: '/images/team/andrea-capera.jpg' },
      { name: 'John Edilberto Charry', role: 'Docente', photo: '/images/team/john-charry.jpg' },
      { name: 'Ruth Correa Millan', role: 'Docente', photo: '/images/team/ruth-correa.jpg' },
      { name: 'Luz Dary Corredor Lemus', role: 'Docente', photo: '/images/team/luz-corredor.jpg' },
      { name: 'Paola Andrea Delgadillo Lucas', role: 'Docente', photo: '/images/team/paola-delgadillo.jpg' },
      { name: 'Durbys Yineth Parra Castaneda', role: 'Docente', photo: '/images/team/durbys-parra.jpg' },
      { name: 'Yeimy Lucrecia Quiroga Quitian', role: 'Docente', photo: '/images/team/yeimy-quiroga.jpg' },
      { name: 'Andres Fernando Quitian Ovalle', role: 'Docente', photo: '/images/team/andres-quitian.jpg' },
      { name: 'Yuri Consuelo Salinas Hernandez', role: 'Docente', photo: '/images/team/yuri-salinas.jpg' },
      { name: 'Jonnatan Villegas Huertas', role: 'Docente', photo: '/images/team/jonnatan-villegas.jpg' },
      { name: 'Ruth Kattia', role: 'Docente', photo: '/images/team/ruth-kattia.jpg' },
      { name: 'Lina Paola Amaya Ordonez', role: 'Docente', photo: '/images/team/lina-amaya.jpg' },
      { name: 'Venjy Alejandra Castillo Gavilan', role: 'Docente', photo: '/images/team/venjy-castillo.jpg' },
    ],
  },
  {
    name: 'Servicios Generales',
    members: [
      { name: 'Ruth Bravo Bermudez', role: 'Economa', photo: '/images/team/ruth-bravo.jpg' },
      { name: 'Maritza Fuquen Ramirez', role: 'Servicios Generales', photo: '/images/team/maritza-fuquen.jpg' },
      { name: 'Lilia Moreno Gonzalez', role: 'Economa', photo: '/images/team/lilia-moreno.jpg' },
      { name: 'John Fredy Perez Pineda', role: 'Servicios Generales', photo: '/images/team/john-perez.jpg' },
      { name: 'Yulieth Rojas Salinas', role: 'Economa', photo: '/images/team/yulieth-rojas.jpg' },
    ],
  },
  {
    name: 'Mantenimiento',
    members: [
      { name: 'Fanny Marin Luz', role: 'Almacenista', photo: '/images/team/fanny-marin.jpg' },
      { name: 'Jesus Antonio Mendez Lozano', role: 'Mantenimiento', photo: '/images/team/jesus-mendez.jpg' },
      { name: 'Orlando Callejas Valencia', role: 'Mantenimiento', photo: '/images/team/orlando-callejas.jpg' },
    ],
  },
];
